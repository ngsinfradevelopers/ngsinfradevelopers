...
const config = {
  ...
  // Location — UPDATED from Google Maps listing
  locationName: "NGS INFRA DEVELOPERS",
  exactAddress: "D No 6-150, NGS Infra Developers, Vinukonda Road, Narasaraopet, Andhra Pradesh 522601",
  ...
  // Registration shown as a trust badge
  registration: {
